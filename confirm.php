  ...
  <body>
    ...
    <div class="main-wrapper">
      <div class="heading-contact">
        ...
        <p>お問い合わせ内容に間違いはありませんか。</p>
        <div class="contact_input">
          <form action="sent.php" method="post">
            <div class="form-item">お名前：</div>
            　　<?php echo escape($name); ?>
            <div class="form-item">メールアドレス：</div>
            　　<?php echo escape($mail); ?>
            <div class="form-item">お問い合わせ内容：</div>
            　　<?php echo nl2br(escape($body)); ?>
            <input type="hidden" name="token" value="<?=$_SESSION['token']?>">
            <div class="submit-confirm">
              <input id="return_btn" type="button" value="内容の修正" onclick="history.back(-1)">
              <input id="submit_btn" type="submit" name="btn_confirm" value="送信">
              <input type="hidden" name="name" value= <?php echo escape($name); ?>>
	            <input type="hidden" name="mail" value= <?php echo escape($mail); ?>>
              <input type="hidden" name="body" value= <?php echo escape($body); ?>>
            </div>
          </form>
        </div>
      </div>
